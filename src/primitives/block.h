...
#ifndef BICOSCOIN_PRIMITIVES_BLOCK_H
#define BICOSCOIN_PRIMITIVES_BLOCK_H
...
public:
    ...
    std::vector<unsigned char> sig; // 각 노드의 블럭 해시 전자서명  //BICOS_SIGN_BYTES*iVerificationLength
    ...
    inline void SerializationOp(Stream& s, Operation ser_action)
    {
        ...
        sig.resize(BICOS_SIGN_BYTES*iVerificationLength);
    ...
    {
        //return (nBits == 0);
        return sig.size() != (BICOS_SIGN_BYTES*iVerificationLength);
    }
...
#endif // BICOSCOIN_PRIMITIVES_BLOCK_H

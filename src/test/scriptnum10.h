...
#ifndef BICOSCOIN_TEST_SCRIPTNUM10_H
#define BICOSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BICOScoin Core 0.10.0, for cross-comparison.
 */
public:

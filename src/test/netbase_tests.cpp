...
{
    BOOST_CHECK(TestSplitHost("www." TEXT_bicos "coin.org", "www." TEXT_bicos "coin.org", -1));
    BOOST_CHECK(TestSplitHost("[www." TEXT_bicos "coin.org]", "www." TEXT_bicos "coin.org", -1));
    BOOST_CHECK(TestSplitHost("www." TEXT_bicos "coin.org:80", "www." TEXT_bicos "coin.org", 80));
    BOOST_CHECK(TestSplitHost("[www." TEXT_bicos "coin.org]:80", "www." TEXT_bicos "coin.org", 80));

...
//    //bool postfork = 0/*nHeight >= params.BCSHeight*/;
//    //
//    //if (postfork == false) {
//    //    // Original BICOScoin PoW.
//    //    return BICOScoinGetNextWorkRequired(pindexLast, pblock, params);
//    //}
//    //else if (nHeight < params.BCSHeight + params.BCSPremineWindow) {
//    //    // PoW limit for premine period.
//    //    unsigned int nProofOfWorkLimit = UintToArith256(params.PowLimit(true)).GetCompact();
//    //    return nProofOfWorkLimit;
//    //}
//    //else if (nHeight < params.BCSHeight + params.BCSPremineWindow + params.nDigishieldAveragingWindow) {
//    //    // Pow limit start for warm-up period.
//    //    return UintToArith256(params.powLimitStart).GetCompact();
//    //}
//    //else if (nHeight < params.BCSZawyLWMAHeight) {
...
//unsigned int BICOScoinGetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
//{
//    assert(pindexLast != nullptr);
//    return UintToArith256(params.PowLimit(false)).GetCompact();
...
//    //assert(pindexFirst);
//    //
//    //return BICOScoinCalculateNextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
//}

//unsigned int BICOScoinCalculateNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
//{
//    return UintToArith256(params.PowLimit(false)).GetCompact();
//    //if (params.fPowNoRetargeting)
//    //    return pindexLast->nBits;
...
//    EhInitialiseState(n, k, state, params.EquihashUseBCSSalt(height));
//
...
#define BLOCK_GENERATION_OPTION eBlockGenerationOption::BCS
...
//	}
//	break;
//	case eBlockGenerationOption::BCS:

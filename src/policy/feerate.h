...
#ifndef BICOSCOIN_POLICY_FEERATE_H
#define BICOSCOIN_POLICY_FEERATE_H
...
//{
//private:
//    CAmount nFeeRate = 14;//0.14% => BCS / 10000 * nFeeRate
//public:
//    CFeeRate() : {}
...
public:
    ...
    CAmount GetFeePerK() const { return 1; } //{ return GetFeePerAmount(1 * COIN); }//bicos : 오류 회피용
...
#endif //  BICOSCOIN_POLICY_FEERATE_H

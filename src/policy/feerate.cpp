...
double CFeeRate::GetBICOSFeeRate()
{
...
{
    //static const double dDustThreshold = 1 / GetBICOSFeeRate();
    //static CAmount nDustThreshold = (1 > ((CAmount)dDustThreshold * GetBICOSFeeRate())) ? dDustThreshold + 1 : dDustThreshold;

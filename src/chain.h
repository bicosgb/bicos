...
#ifndef BICOSCOIN_CHAIN_H
#define BICOSCOIN_CHAIN_H
 ...
 */
static const int64_t BICOSCOIN_MAX_FUTURE_BLOCK_TIME = 2 * 60 * 60;
 ...
 */
static const int64_t TIMESTAMP_WINDOW = BICOSCOIN_MAX_FUTURE_BLOCK_TIME;

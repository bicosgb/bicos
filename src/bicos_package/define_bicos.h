#ifndef DEFINE_BICOS_H
#define DEFINE_BICOS_H

#define TEXT_bicos "bicos"
#define TEXT_BICOS "BICOS"
#define TEXT_BICOS "BICOS"

//bicos 네트워크의 최대 코인
#define MAXIMUM_COIN_OF_BICOS_NETWORK 92233720368 //소수점 자리수가 있어서 BCS 은 100억 단위가 한계
...
#define UPDATE_SITE_ADDRESS "https://wallet-version." TEXT_bicos ".io/app/update/" //wallet-version.bicos.io
#define UPDATE_VERSION_MANAGEMENT_FILE UPDATE_VERSION_MANAGEMENT_FILE_PREFIX TEXT_bicos "coin-qt.version.xml"


//다음 블럭 사이즈는 운영 이후 값 줄이면 안됨.
extern const unsigned int BICOS_MAX_BLOCK_SIZE;
extern const unsigned int BICOS_DEFAULT_BLOCK_SIZE;
...
#define GENESIS_BLOCK_TIME_STAMP "The BICOS August 5, 2018"
#define DNS_SEED_MAINNET vSeeds.emplace_back("mainnet01." TEXT_bicos ".io", false); vSeeds.emplace_back("mainnet02." TEXT_bicos ".io", false); vSeeds.emplace_back("mainnet03." TEXT_bicos ".io", false);
#define DNS_SEED_TESTNET vSeeds.emplace_back("testnet01." TEXT_bicos ".io", false); vSeeds.emplace_back("testnet02." TEXT_bicos ".io", false); vSeeds.emplace_back("testnet03." TEXT_bicos ".io", false); \
                         vSeeds.emplace_back("testnet01." TEXT_bicos ".com", false); vSeeds.emplace_back("testnet02." TEXT_bicos ".com", false); 
...
//qt지갑에서 qr 코드 사용하는가?
#define BICOS_USE_QRCODE 0

//블럭 해더 서명 크기
#define BICOS_SIGN_BYTES 64

#endif //DEFINE_BICOS_H

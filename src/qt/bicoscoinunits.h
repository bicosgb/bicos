...
#ifndef BICOSCOIN_QT_BICOSCOINUNITS_H
#define BICOSCOIN_QT_BICOSCOINUNITS_H
...
/** BICOScoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BICOScoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BICOScoinUnits(QObject *parent);

    /** BICOScoin units.
     *  BICOScoin units (BICOScoin Core unit work the same as Bitoin).
     *  @note Source: https://en.bicoscoin.it/wiki/Units . 
...
typedef BICOScoinUnits::Unit BICOScoinUnit;

#endif // BICOSCOIN_QT_BICOSCOINUNITS_H

...
#ifndef BICOSCOIN_SCRIPT_INTERPRETER_H
#define BICOSCOIN_SCRIPT_INTERPRETER_H
...
{
    FORKID_BCC = 0,
    FORKID_BCS = 79, // Atomic number AU
};

static const int FORKID_IN_USE = FORKID_BCS;
...
enum
{
    ...
    // Allow NON_FORKID in legacy tests and blocks under BCS hard fork height
    //
...
#endif // BICOSCOIN_SCRIPT_INTERPRETER_H

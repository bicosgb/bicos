...
unlocked to sign the BICOScoin-Qt.app bundle.
...
allowing somebody to distribute a BICOScoin-Qt.app or bicoscoin-qt-setup.exe with a valid
...
that the bicoscoin-qt.exe file inside the installer had not been tampered with.

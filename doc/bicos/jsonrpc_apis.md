...
arguments sample:
```text
bicoscoin-cli getbestblockhash
```
...
arguments sample:
```text
bicoscoin-cli getblockhash 241
```
...
arguments sample:
```text
bicoscoin-cli getblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce 0
```
...
arguments sample:
```text
bicoscoin-cli getblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce 1
```
...
arguments sample:
```text
bicoscoin-cli getblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce 2
```
...
argument sample:
```text
bicoscoin-cli getrawtransaction 85fbb772ed71c7d4081ed16df46436d7acdc58c0832c765278c19c5684621369 1
```
...
argument sample:
```text
bicoscoin-cli getrawtransaction 85fbb772ed71c7d4081ed16df46436d7acdc58c0832c765278c19c5684621369 0
```
...
arguments sample:
```text
bicoscoin-cli getaccountaddress bicos-test.com
```
...
arguments sample:
```text
bicoscoin-cli getnewaddress bicos-test.com
```
...
arguments sample:
```text
bicoscoin-cli getaddressesbyaccount bicos-test.com
```
...
arguments sample:
```text
bicoscoin-cli getaccount wE5NLPUFcVLCD7xTmzxHMYYsc47tLD2gcA
```
...
arguments sample:
```text
bicoscoin-cli listaccounts
```

result sample:
```json
{
 "bicos-test.bicos.com": 0.00000000,
  "bicos-test1.bicos.com": 100.00000000
}
```
...
arguments sample:
```text
bicoscoin-cli getbalance bicos-test.com
```
...
arguments sample:
```text
bicoscoin-cli sendfrom bicos-test.com MSKCithw8Vnrcqo8xJ1WedWnc9LDsgqvAY 10
```
...
arguments sample:
```text
bicoscoin-cli gettransaction 6735e9f16cab2aafb9b36f75d60963124cd1a63ad516bc75c3ec96e50e90c716
```
...
```json
{
  ...
  "details": [
    {
      "account": "bicos-test.com",
      "address": "MSKCithw8Vnrcqo8xJ1WedWnc9LDsgqvAY",
      "category": "send",
      "amount": -10.00000000,
      "label": "bicos-test.com",
      "vout": 1,
      "fee": -0.01300000,
      "abandoned": false
    }, 
...
arguments sample:
```text
bicoscoin-cli listsinceblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce
```

...
This document provides guidelines for internationalization of the BICOScoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bicoscoin_en.ts` remains unchanged.

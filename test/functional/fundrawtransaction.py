...
from test_framework.test_framework import BICOScoinTestFramework, BICOSCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(BICOScoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid bicoscoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.bicoscoind_processes[1].wait(timeout=BICOSCOIND_PROC_WAIT_TIMEOUT)

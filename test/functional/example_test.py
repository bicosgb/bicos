...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BICOScoinTestFramework
    pass

class ExampleTest(BICOScoinTestFramework):
    # Each functional test is a subclass of the BICOScoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BICOScoinTestFramework class so other tests can use it."""

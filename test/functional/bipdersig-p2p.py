...
class BIP66Test(BICOScoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bicoscoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bicoscoind produces more specific reject
            # reasons.
